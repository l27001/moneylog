...
def not_found(e):
    return render_template('error.html',
        ...
        description = 'Страница которую вы запросили не может быть найдена. Возможно она была удалена или перемещена.'), e.code
...
def no_access(e):
    return render_template('error.html',
        ...
        description = 'У Вас нет прав доступа к этому объекту. Файл недоступен для чтения, или сервер не может его прочитать.'), e.code
...
def internal_error(e):
    return render_template('error.html',
        ...
        description = 'Произошла неизвестная ошибка. Попробуйте обновить страницу, или вернитесь сюда позже.'), e.code
